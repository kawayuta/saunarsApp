...
//  saucialApp
//
//  Created by kawayuta on 4/13/21.
//
...
struct Config {
    ...
    static let waveMinLedge = 0.0
    static let waveMinHR = 48.0
    static let waveMinVR = 82.0

    static let colors = [0xf2f9fd, 0x0074D9, 0x39CCCC].map { val in Color(hex: val) }
    
    static let pages: [PagesView] = [PagesView.home, PagesView.mypage, PagesView.activity]
