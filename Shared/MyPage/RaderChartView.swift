...
//  saucialApp
//
//  Created by kawayuta on 4/25/21.
//
...
let dimensions = [
    Ray(maxVal: 100, rayCase: .cleanliness),
    Ray(maxVal: 100, rayCase: .customer_service),
    Ray(maxVal: 100, rayCase: .equipment),
    Ray(maxVal: 100, rayCase: .customer_manner),
    Ray(maxVal: 100, rayCase: .cost_performance)
]
...
enum RayCase:String, CaseIterable {
    case cleanliness = "清潔感"
    case customer_service = "接客"
    case equipment = "設備"
    case customer_manner = "お客マナー"
    case cost_performance = "コストパフォーマンス"
}
...
struct DataPoint:Identifiable {
    ...
    init(base:Double, content:Double, speedweb:Double, speedmobile:Double, social:Double, color:Color){
        self.entrys = [
            RayEntry(rayCase: .cleanliness, value: base),
            RayEntry(rayCase: .customer_service, value: content),
            RayEntry(rayCase: .equipment, value: speedweb),
            RayEntry(rayCase: .customer_manner, value: speedmobile),
            RayEntry(rayCase: .cost_performance, value: social)
        ]
        self.color = color
    }
}
