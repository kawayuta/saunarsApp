...
class RecommendCardOverlay: UIView {
  ...
  private func createLeftOverlay() {
    let leftTextView = TinderCardOverlayLabelView(withTitle: "う〜ん",
                                                  color: Color(hex: "bbb").toUIColor()!,
  ...
  private func createRightOverlay() {
    let rightTextView = TinderCardOverlayLabelView(withTitle: "行きたい！",
                                                   color: .blue,
                                                   rotation: -CGFloat.pi / 10)
