...
//            secondStepView(viewModel: viewModel)
            ZStack(alignment: Alignment(horizontal: .leading, vertical: .bottom)) {
                    ...
                    }.frame(height: UIScreen.main.nativeBounds.height == 1334 ?
                        (viewModel.selectedTab == 3 ? 280 : viewModel.selectedTab == 2 || viewModel.selectedTab == 0 ? 380 : 540) :
                        (viewModel.selectedTab == 0 || viewModel.selectedTab == 1 ? 540 : 400)
                    )
