...
//            saunaviViewModel.message = "r21r21r2"
//            if viewModel.buildings.count == 0 { saunaviViewModel.message = "このエリアにはサウナが見つからないみたいだ..." }
//            else { saunaviViewModel.message = "\(viewModel.buildings.count)件のサウナが見つかったよ！" }
